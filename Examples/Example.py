...
if __name__ == '__main__':
   ...
   raytrace_data=rtrace(Radius=r,Focallength=x0,Lengthpar=lp,Lengthhyp=lh,ShellThickness=st,Theta=theta,DetectorPosition=0,Raydensity=100,SurfaceType="wo", Error='yes',Approx='yes',Gp=gp,dGp=dgp,Gh=gh,dGh=dgh)
