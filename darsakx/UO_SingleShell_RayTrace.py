...
def uo_ray_trace(r0,x0,xi,theta,lp,lh,dl,xd,Gp,Gh,dGp,dGh):
    ...
    for i in range(len(xh)):
      def func(xh):
        f=Gh(xh) -np.sqrt(A1[i]*xh**2+B1[i]*xh+C1[i])
        return f
